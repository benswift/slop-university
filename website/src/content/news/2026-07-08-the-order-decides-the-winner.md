---
title: Slop University's shortlisting tool changes its mind when the order flips
subtitle:
  Reversing presentation order changed the winner in a third of Demo Quarter
  comparisons, and would have reshuffled a fifth of the shortlist
date: 2026-07-08
description:
  New findings from the School of Continuous Improvement show that Demo
  Quarter's pairwise-comparison shortlisting instrument returns a different
  winner for the same pair of entries depending only on which one is shown
  first.
